...
local function Apply(model, w, h, x, y, sigh, norotate)
	...
	gmodel:SetScript("OnMouseDown", function() OnMouseDown(this,arg1) end)
	gmodel:SetScript("OnMouseUp", function() OnMouseUp(this,arg1) end)
	gmodel:SetScript("OnMouseWheel", function() OnMouseWheel(this,arg1) end)
	gmodel:SetScript("OnUpdate", function() OnUpdate(this) end)
end
...
local function newbutton(name, parent, text, w, h, button, tt, func)
	...
	if tt then
		b.tt = tt
		b:SetScript("OnEnter", function() gttshow(this) end)
